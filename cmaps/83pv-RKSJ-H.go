...
type pdfCmap struct {
	wmode        int
	codespaces   []pdfCodespace
	numCharCodes int
	numGlyphIDs  int
	ranges       [222]PDFRange // Assuming pdfRange is defined elsewhere
	// ... other fields as needed (xranges, mranges, table, splay tree)
}

type pdfCodespace struct {
	wmode int
	low   int
	high  int
}
...
var (
	cmap_83pv_RKSJ_H_ranges = [...]PDFRange{
		{0x20, 0x7e, 0x1},
		{0x80, 0x80, 0x61},
		{0xa0, 0xdf, 0x146},
		{0xfd, 0xfd, 0x98},
...
var cmap_83pv_RKSJ_H = pdfCmap{
	...
	numCharCodes: 222,
	numGlyphIDs:  222,
	ranges:       cmap_83pv_RKSJ_H_ranges, // Assuming cmap_83pv_RKSJ_H_ranges is defined elsewhere as a slice of pdfRange
}
